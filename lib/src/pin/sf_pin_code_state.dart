...
class _SFPinCodeState extends State<SFPinCode>
    with RestorationMixin, WidgetsBindingObserver, _SFPinCodeUtilsMixin
  ...
  late final _SFPinCodeSelectionGestureDetectorBuilder _gestureDetectorBuilder;
  ...
  void initState() {
    ...
    _gestureDetectorBuilder =
        _SFPinCodeSelectionGestureDetectorBuilder(state: this);
  ...
  void _maybeValidateForm() {
    if (widget.sfPinAutovalidateMode == SFPinAutovalidateMode.onSubmit) {
      _validator();
    }
  }
  ...
  @override
  void didUpdateWidget(SFPinCode oldWidget) {
    ...
    return RepaintBoundary(
      child: UnmanagedRestorationScope(
        ...
        child: EditableText(
          key: editableTextKey,
          maxLines: 1,
          style: SFPinCodeConstants._hiddenTextStyle,
          onChanged: (value) {
