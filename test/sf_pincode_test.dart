...
void main() {
  Future<void> pumpSFPinCode(WidgetTester tester, Widget sfPinCode) async {
  ...
  testWidgets('Pins are displayed', (tester) async {
    const length = 4;
    await pumpSFPinCode(tester, const SFPinCode(length: length));
  ...
  testWidgets('Should properly handle states', (WidgetTester tester) async {
    ...
    const defaultTheme = SFPinTheme(decoration: BoxDecoration(color: Colors.red));
    ...
    await pumpSFPinCode(tester, SFPinCode(
        length: length,
        focusNode: focusNode,
        defaultSFPinTheme: defaultTheme,
        focusedSFPinTheme: focusedTheme,
        submittedSFPinTheme: submittedTheme,
        followingSFPinTheme: followingTheme,
        disabledSFPinTheme: disabledTheme,
        errorSFPinTheme: errorTheme,
    ));

    void testState(int count, SFPinTheme theme) {
      expect(
  ...
  testWidgets('Should properly handle focused state',
    ...
    final focusNode = FocusNode();
    const defaultTheme = SFPinTheme(decoration: BoxDecoration());
  ...
  testWidgets('Should display custom cursor', (WidgetTester tester) async {
    await pumpSFPinCode(tester, const SFPinCode(
        autofocus: true,
        cursor: FlutterLogo(),
    ));
